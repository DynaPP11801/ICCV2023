...
from canvas_packanddetect import *
...
#     dt = Profile(), Profile(), Profile()  # profiling times
    ...
    for batch_i, (im, targets, paths, shapes) in enumerate(pbar):
        ...
        with torch.no_grad():
            if whether_pack == False or key_frame ==0:
                ...
                pack = True
                with dt[5]:
                    packed_img, where_old_image, where_new_image, groups_groups = canvas(im, preds[0][:,:4], where_old_image, where_new_image, prev_out, background)
                ...
                all_img_shape[(packed_img.size(2)+div_sz//2)//div_sz-1, (packed_img.size(3)+div_sz//2)//div_sz-1] += 1
    ...
    if not training:
        if whether_pack == False:
            ...
            load_wb = load_workbook(f'excel_result/{dataset_name}_results_packanddetect.xlsx', data_only = True)
        ...
        if whether_pack == False:
            ...
            write_wb.save(f'excel_result/{dataset_name}_results_packanddetect.xlsx')
